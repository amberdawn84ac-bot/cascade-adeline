...
import { GraduationCap, Wrench, Building2, Shield, Loader2, Send, ChevronRight } from 'lucide-react';
...
4. Connect everything to the three pillars: Trade/Apprenticeship, Business, and Graduation Defense.
...
type Tab = 'transcript' | 'trade' | 'business' | 'defense';
