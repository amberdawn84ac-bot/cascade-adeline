  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Coding Challenge */}
        <Link href="/dashboard/arcade/coding" className="group block">
          <div className="bg-white p-6 rounded-[2rem] border-2 border-violet-100 hover:border-violet-300 transition-all hover:shadow-lg cursor-pointer">
        ...
        {/* Game Design */}
        <Link href="/dashboard/arcade/game-design" className="group block">
          <div className="bg-white p-6 rounded-[2rem] border-2 border-violet-100 hover:border-violet-300 transition-all hover:shadow-lg cursor-pointer">
        ...
        {/* Logic Puzzles */}
        <Link href="/dashboard/arcade/logic-puzzles" className="group block">
          <div className="bg-white p-6 rounded-[2rem] border-2 border-violet-100 hover:border-violet-300 transition-all hover:shadow-lg cursor-pointer">
